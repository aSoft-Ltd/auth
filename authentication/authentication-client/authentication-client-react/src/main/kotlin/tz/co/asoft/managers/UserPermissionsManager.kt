...
//    override val viewModel by lazy { props.locator.userPermissionsManager() }
//
//    class Props(val u: User, val locator: AuthenticationViewModelLocator) : RProps
//
...
//) = child(UserPermissionsManager::class.js, Props(user, locator)) {}
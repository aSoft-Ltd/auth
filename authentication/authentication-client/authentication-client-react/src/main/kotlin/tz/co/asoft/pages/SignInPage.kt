...
//
//@JsExport
//class SignInPage private constructor() : VComponent<Props, Intent, State, LoginFormViewModel>() {
//    override val viewModel by lazy { props.locator.loginForm() }
//
//    class Props(
//        val imageUrl: String,
...
//) = child(withRouter(SignInPage::class), Props(imageUrl, includeSignUpLink, locator, overlay)) {}